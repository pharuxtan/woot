...
デフォルトでは、<ItemImage id="minecraft:enchanted_book" scale="0.5"/>エンチャントの本のレベルごとに2500mBの<ItemImage id="enchanted_fluid_bucket" scale="0.5"/>エンチャント液が生成されます。上限は<WootConfig key="enchanted_liquifier.max_enchant_lvl" />までです。
