...
public abstract class WootUpgradeItemRegistration {
     ...
     */
    public abstract <T extends Enum<T> & WootUpgradeEnum<T>> void register(RegistryObject<? extends WootUpgradeItem<T>> item);
     ...
     * @param <T>            the variant enum type used by the item
     */
    public abstract <T extends Enum<T> & WootUpgradeEnum<T>> void register(RegistryObject<? extends WootUpgradeItem<T>> item, Class<T> dynamicVariant);
