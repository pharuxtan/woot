...
public class Dimension extends WootUpgradeItem<Dimension.Variant> {
    ...
    public static final RegistryObject<Dimension> NETHER_DIMENSION_ITEM = ITEMS.register(NETHER_DIMENSION_TAG, () -> new Dimension(Variant.NETHER));

    public static final String END_DIMENSION_TAG = "end_dimension_upgrade";
    public static final RegistryObject<Dimension> END_DIMENSION_ITEM = ITEMS.register(END_DIMENSION_TAG, () -> new Dimension(Variant.END));
}
