...
public class ShardDrop extends WootUpgradeItem<UpgradeDefaultVariant> {
    ...
    public static final RegistryObject<ShardDrop> IRON_SHARD_DROP_ITEM = ITEMS.register(IRON_SHARD_DROP_TAG, () -> new ShardDrop(UpgradeDefaultVariant.IRON));

    public static final String GOLD_SHARD_DROP_TAG = "gold_shard_drop_upgrade";
    public static final RegistryObject<ShardDrop> GOLD_SHARD_DROP_ITEM = ITEMS.register(GOLD_SHARD_DROP_TAG, () -> new ShardDrop(UpgradeDefaultVariant.GOLD));

    public static final String DIAMOND_SHARD_DROP_TAG = "diamond_shard_drop_upgrade";
    public static final RegistryObject<ShardDrop> DIAMOND_SHARD_DROP_ITEM = ITEMS.register(DIAMOND_SHARD_DROP_TAG, () -> new ShardDrop(UpgradeDefaultVariant.DIAMOND));

    public static final String NETHERITE_SHARD_DROP_TAG = "netherite_shard_drop_upgrade";
    public static final RegistryObject<ShardDrop> NETHERITE_SHARD_DROP_ITEM = ITEMS.register(NETHERITE_SHARD_DROP_TAG, () -> new ShardDrop(UpgradeDefaultVariant.NETHERITE));
}
