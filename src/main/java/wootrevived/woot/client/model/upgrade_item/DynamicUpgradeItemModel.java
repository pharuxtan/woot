...
public class DynamicUpgradeItemModel implements ItemModel {
    ...
    private DynamicUpgradeItemModel(ItemModel.BakingContext bakingContext) {
    ...
    private ItemModel bakeModel(String key) {
        ...
        RenderTypeGroup renderType = new RenderTypeGroup(RenderType.translucent(), NeoForgeRenderTypes.ITEM_UNSORTED_TRANSLUCENT.get());
    ...
    @Override
    public void update(@NotNull ItemStackRenderState renderState, @NotNull ItemStack stack, @NotNull ItemModelResolver modelResolver, @NotNull ItemDisplayContext displayContext, @Nullable ClientLevel level, @Nullable LivingEntity entity, int seed) {
        ...
        cache.computeIfAbsent(variant, this::bakeModel)
                .update(renderState, stack, modelResolver, displayContext, level, entity, seed);
    }
