...
public class FactoryUpgradeBlockBaseModel implements CustomUnbakedBlockStateModel {
    ...
    public static final ResourceLocation ID = Woot.location(BlocksRegistry.FACTORY_UPGRADE_TAG);
    ...
    public BlockStateModel bake(ModelBaker modelBaker) {
        ResolvedModel parent = modelBaker.getModel(Woot.location("block/factory_upgrade"));
        return FactoryUpgradeDynamicModel.bake(parent, modelBaker);
    }

    @Override
    public void resolveDependencies(Resolver resolver) {
        resolver.markDependency(Woot.location("block/factory_upgrade"));
    }
