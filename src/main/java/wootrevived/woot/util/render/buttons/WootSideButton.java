...
public class WootSideButton extends WootButton {
    ...
    protected void renderWidget(GuiGraphics gui, int mouseX, int mouseY, float partialTick) {
        gui.blit(RenderPipelines.GUI_TEXTURED, WootContainerScreen.GUI, getX(), getY(), 200, 177, getWidth(), getHeight(), WootContainerScreen.ATLAS_WIDTH, WootContainerScreen.ATLAS_HEIGHT);
        ...
        if(isHovered()) {
            ...
            gui.setTooltipForNextFrame(WootContainerScreen.getMCFont(), name, mouseX, mouseY);
        }
