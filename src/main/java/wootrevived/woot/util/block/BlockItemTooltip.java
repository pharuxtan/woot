...
public class BlockItemTooltip<T extends TooltipProvider> extends BlockItem {
    private final DataComponentType<T> type;

    public BlockItemTooltip(Block block, DataComponentType<T> type, Properties properties) {
