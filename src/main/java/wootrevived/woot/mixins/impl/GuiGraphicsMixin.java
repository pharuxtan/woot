...
public interface GuiGraphicsMixin {
    ...
    @Invoker("innerBlit")
    void woot$innerBlit(RenderPipeline renderTypeGetter, Identifier atlasLocation, int x1, int x2, int y1, int y2, float minU, float maxU, float minV, float maxV, int color);
