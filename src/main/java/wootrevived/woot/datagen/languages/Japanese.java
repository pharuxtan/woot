...
public class Japanese extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(BlocksRegistry.COPPER_MAGMATOR_BLOCK.get(), "銅のマグマーター");
        add(BlocksRegistry.IRON_MAGMATOR_BLOCK.get(), "鉄のマグマーター");
        add(BlocksRegistry.GOLD_MAGMATOR_BLOCK.get(), "金のマグマーター");
        add(BlocksRegistry.DIAMOND_MAGMATOR_BLOCK.get(), "ダイヤモンドのマグマーター");
        add(BlocksRegistry.NETHERITE_MAGMATOR_BLOCK.get(), "ネザライトのマグマーター");
