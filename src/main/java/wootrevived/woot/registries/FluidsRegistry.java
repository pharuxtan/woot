...
public class FluidsRegistry {
    public static final DeferredRegister<FluidType> FLUID_TYPES = DeferredRegister.create(NeoForgeRegistries.FLUID_TYPES, Woot.MOD_NAMESPACE);
    public static final DeferredRegister<Fluid> FLUIDS = DeferredRegister.create(BuiltInRegistries.FLUID, Woot.MOD_NAMESPACE);
    ...
    public static final Identifier UNDERWATER_OVERLAY_RL = Identifier.withDefaultNamespace("misc/underwater");
    ...
    public static final Identifier VITALITY_FUEL_STILL_TEX = Woot.identifier("block/vitality_fuel_still");
    public static final Identifier VITALITY_FUEL_FLOW_TEX = Woot.identifier("block/vitality_fuel_flow");
    ...
    public static final DeferredHolder<Block, LiquidBlock> VITALITY_FUEL_FLUID_BLOCK = BLOCKS.register(VITALITY_FUEL_FLUID_TAG + "_block", () -> new LiquidBlock(SOURCE_VITALITY_FUEL_FLUID.get(), BlockBehaviour.Properties.ofFullCopy(net.minecraft.world.level.block.Blocks.WATER).noLootTable().setId(ResourceKey.create(Registries.BLOCK, Woot.identifier(VITALITY_FUEL_FLUID_TAG + "_block")))));
    public static final DeferredHolder<Item, BucketItem> VITALITY_FUEL_FLUID_BUCKET = ITEMS.register(VITALITY_FUEL_FLUID_TAG + "_bucket", () -> new BucketItem(SOURCE_VITALITY_FUEL_FLUID.get(), new BucketItem.Properties().craftRemainder(Items.BUCKET).stacksTo(1).setId(ResourceKey.create(Registries.ITEM, Woot.identifier(VITALITY_FUEL_FLUID_TAG + "_bucket")))));
    ...
    public static final Identifier PURE_DYE_STILL_TEX = Woot.identifier("block/pure_dye_still");
    public static final Identifier PURE_DYE_FLOW_TEX = Woot.identifier("block/pure_dye_flow");
    ...
    public static final DeferredHolder<Block, LiquidBlock> PURE_DYE_FLUID_BLOCK = BLOCKS.register(PURE_DYE_FLUID_TAG + "_block", () -> new LiquidBlock(SOURCE_PURE_DYE_FLUID.get(), BlockBehaviour.Properties.ofFullCopy(net.minecraft.world.level.block.Blocks.WATER).noLootTable().setId(ResourceKey.create(Registries.BLOCK, Woot.identifier(PURE_DYE_FLUID_TAG + "_block")))));
    public static final DeferredHolder<Item, BucketItem> PURE_DYE_FLUID_BUCKET = ITEMS.register(PURE_DYE_FLUID_TAG + "_bucket", () -> new BucketItem(SOURCE_PURE_DYE_FLUID.get(), new BucketItem.Properties().craftRemainder(Items.BUCKET).stacksTo(1).setId(ResourceKey.create(Registries.ITEM, Woot.identifier(PURE_DYE_FLUID_TAG + "_bucket")))));
    ...
    public static final Identifier ENCHANTED_STILL_TEX = Woot.identifier("block/enchanted_still");
    public static final Identifier ENCHANTED_FLOW_TEX = Woot.identifier("block/enchanted_flow");
    ...
    public static final DeferredHolder<Block, LiquidBlock> ENCHANTED_FLUID_BLOCK = BLOCKS.register(ENCHANTED_FLUID_TAG + "_block", () -> new LiquidBlock(SOURCE_ENCHANTED_FLUID.get(), BlockBehaviour.Properties.ofFullCopy(net.minecraft.world.level.block.Blocks.WATER).noLootTable().setId(ResourceKey.create(Registries.BLOCK, Woot.identifier(ENCHANTED_FLUID_TAG + "_block")))));
    public static final DeferredHolder<Item, BucketItem> ENCHANTED_FLUID_BUCKET = ITEMS.register(ENCHANTED_FLUID_TAG + "_bucket", () -> new BucketItem(SOURCE_ENCHANTED_FLUID.get(), new BucketItem.Properties().craftRemainder(Items.BUCKET).stacksTo(1).setId(ResourceKey.create(Registries.ITEM, Woot.identifier(ENCHANTED_FLUID_TAG + "_bucket")))) {
        @Override
    ...
    public static final Identifier MOB_TEARS_STILL_TEX = Woot.identifier("block/mob_tears_still");
    public static final Identifier MOB_TEARS_FLOW_TEX = Woot.identifier("block/mob_tears_flow");
