...
public class BlocksRegistry {
    ...
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(BuiltInRegistries.BLOCK, Woot.MOD_NAMESPACE);
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITY_TYPES = DeferredRegister.create(BuiltInRegistries.BLOCK_ENTITY_TYPE, Woot.MOD_NAMESPACE);
    ...
    public static final DeferredHolder<Item, Item> CREATIVE_POWER_BLOCK_ITEM = ITEMS.register(CREATIVE_POWER_TAG, () -> new BlockItem(CREATIVE_POWER_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(CREATIVE_POWER_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> CREATIVE_TANK_BLOCK_ITEM = ITEMS.register(CREATIVE_TANK_TAG, () -> new BlockItem(CREATIVE_TANK_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(CREATIVE_TANK_TAG))).component(ComponentsRegistry.CREATIVE_TANK_DATA, new CreativeTankData.Component(FluidStack.EMPTY))));
    ...
    public static final DeferredHolder<Item, Item> FACTORY_BASE_BLOCK_ITEM = ITEMS.register(FACTORY_BASE_TAG, () -> new BlockItem(FACTORY_BASE_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(FACTORY_BASE_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> ITEM_INFUSER_BLOCK_ITEM = ITEMS.register(ITEM_INFUSER_TAG, () -> new BlockItemTooltip<>(ITEM_INFUSER_BLOCK.get(), ComponentsRegistry.ITEM_INFUSER_BLOCK_TOOLTIP.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(ITEM_INFUSER_TAG))).component(ComponentsRegistry.ITEM_INFUSER_BLOCK_TOOLTIP, ItemInfuserBlock.Tooltip.INSTANCE).component(ComponentsRegistry.ITEM_INFUSER_DATA, new ItemInfuserData.Component(0, FluidStack.EMPTY, new ArrayList<>()))));
    ...
    public static final DeferredHolder<Item, Item> LAYOUT_BLOCK_ITEM = ITEMS.register(LAYOUT_TAG, () -> new BlockItem(LAYOUT_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(LAYOUT_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> HEART_BLOCK_ITEM = ITEMS.register(HEART_TAG, () -> new FactoryBlockItem(HEART_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(HEART_TAG)))));
    ...
    public static final DeferredHolder<Item, FakeSpawnerBlockItem> FAKE_SPAWNER_BLOCK_ITEM = ITEMS.register(FAKE_SPAWNER_TAG, () -> new FakeSpawnerBlockItem(FAKE_SPAWNER_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(FAKE_SPAWNER_TAG))).component(ComponentsRegistry.FAKE_SPAWNER_DATA, new FakeSpawnerData.Component(Optional.empty()))));
    ...
    public static final DeferredHolder<Item, Item> FACTORY_CONNECT_BLOCK_ITEM = ITEMS.register(FACTORY_CONNECT_TAG, () -> new FactoryBlockItem(FACTORY_CONNECT_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(FACTORY_CONNECT_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> IMPORT_BLOCK_ITEM = ITEMS.register(IMPORT_TAG, () -> new FactoryBlockItem(IMPORT_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(IMPORT_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> EXPORT_BLOCK_ITEM = ITEMS.register(EXPORT_TAG, () -> new FactoryBlockItem(EXPORT_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(EXPORT_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> FACTORY_CTR_BASE_PRI_BLOCK_ITEM = ITEMS.register(FACTORY_CTR_BASE_PRI_TAG, () -> new FactoryBlockItem(FACTORY_CTR_BASE_PRI_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(FACTORY_CTR_BASE_PRI_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> FACTORY_CTR_BASE_SEC_BLOCK_ITEM = ITEMS.register(FACTORY_CTR_BASE_SEC_TAG, () -> new FactoryBlockItem(FACTORY_CTR_BASE_SEC_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(FACTORY_CTR_BASE_SEC_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> FACTORY_UPGRADE_BLOCK_ITEM = ITEMS.register(FACTORY_UPGRADE_TAG, () -> new FactoryBlockItem(FACTORY_UPGRADE_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(FACTORY_UPGRADE_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> COPPER_PYLON_BLOCK_ITEM = ITEMS.register(COPPER_PYLON_TAG, () -> new FactoryBlockItem(COPPER_PYLON_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(COPPER_PYLON_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> COPPER_PLINTH_BLOCK_ITEM = ITEMS.register(COPPER_PLINTH_TAG, () -> new FactoryBlockItem(COPPER_PLINTH_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(COPPER_PLINTH_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> COPPER_CELL_BLOCK_ITEM = ITEMS.register(COPPER_CELL_TAG, () -> new FactoryBlockItemTooltip<>(COPPER_CELL_BLOCK.get(), ComponentsRegistry.CELL_BLOCK_TOOLTIP.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(COPPER_CELL_TAG))).component(ComponentsRegistry.CELL_BLOCK_TOOLTIP, new CellBlock.Tooltip(Tier.TIER_1)).component(ComponentsRegistry.CELL_DATA, new CellData.Component(FluidStack.EMPTY))));
    ...
    public static final DeferredHolder<Item, Item> IRON_PYLON_BLOCK_ITEM = ITEMS.register(IRON_PYLON_TAG, () -> new FactoryBlockItem(IRON_PYLON_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(IRON_PYLON_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> IRON_PLINTH_BLOCK_ITEM = ITEMS.register(IRON_PLINTH_TAG, () -> new FactoryBlockItem(IRON_PLINTH_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(IRON_PLINTH_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> IRON_CELL_BLOCK_ITEM = ITEMS.register(IRON_CELL_TAG, () -> new FactoryBlockItemTooltip<>(IRON_CELL_BLOCK.get(), ComponentsRegistry.CELL_BLOCK_TOOLTIP.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(IRON_CELL_TAG))).component(ComponentsRegistry.CELL_BLOCK_TOOLTIP, new CellBlock.Tooltip(Tier.TIER_2)).component(ComponentsRegistry.CELL_DATA, new CellData.Component(FluidStack.EMPTY))));
    ...
    public static final DeferredHolder<Item, Item> GOLD_PYLON_BLOCK_ITEM = ITEMS.register(GOLD_PYLON_TAG, () -> new FactoryBlockItem(GOLD_PYLON_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(GOLD_PYLON_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> GOLD_PLINTH_BLOCK_ITEM = ITEMS.register(GOLD_PLINTH_TAG, () -> new FactoryBlockItem(GOLD_PLINTH_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(GOLD_PLINTH_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> GOLD_CELL_BLOCK_ITEM = ITEMS.register(GOLD_CELL_TAG, () -> new FactoryBlockItemTooltip<>(GOLD_CELL_BLOCK.get(), ComponentsRegistry.CELL_BLOCK_TOOLTIP.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(GOLD_CELL_TAG))).component(ComponentsRegistry.CELL_BLOCK_TOOLTIP, new CellBlock.Tooltip(Tier.TIER_3)).component(ComponentsRegistry.CELL_DATA, new CellData.Component(FluidStack.EMPTY))));
    ...
    public static final DeferredHolder<Item, Item> DIAMOND_PYLON_BLOCK_ITEM = ITEMS.register(DIAMOND_PYLON_TAG, () -> new FactoryBlockItem(DIAMOND_PYLON_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(DIAMOND_PYLON_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> DIAMOND_PLINTH_BLOCK_ITEM = ITEMS.register(DIAMOND_PLINTH_TAG, () -> new FactoryBlockItem(DIAMOND_PLINTH_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(DIAMOND_PLINTH_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> DIAMOND_CELL_BLOCK_ITEM = ITEMS.register(DIAMOND_CELL_TAG, () -> new FactoryBlockItemTooltip<>(DIAMOND_CELL_BLOCK.get(), ComponentsRegistry.CELL_BLOCK_TOOLTIP.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(DIAMOND_CELL_TAG))).component(ComponentsRegistry.CELL_BLOCK_TOOLTIP, new CellBlock.Tooltip(Tier.TIER_4)).component(ComponentsRegistry.CELL_DATA, new CellData.Component(FluidStack.EMPTY))));
    ...
    public static final DeferredHolder<Item, Item> NETHERITE_PYLON_BLOCK_ITEM = ITEMS.register(NETHERITE_PYLON_TAG, () -> new FactoryBlockItem(NETHERITE_PYLON_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(NETHERITE_PYLON_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> NETHERITE_PLINTH_BLOCK_ITEM = ITEMS.register(NETHERITE_PLINTH_TAG, () -> new FactoryBlockItem(NETHERITE_PLINTH_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(NETHERITE_PLINTH_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> NETHERITE_CELL_BLOCK_ITEM = ITEMS.register(NETHERITE_CELL_TAG, () -> new FactoryBlockItemTooltip<>(NETHERITE_CELL_BLOCK.get(), ComponentsRegistry.CELL_BLOCK_TOOLTIP.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(NETHERITE_CELL_TAG))).component(ComponentsRegistry.CELL_BLOCK_TOOLTIP, new CellBlock.Tooltip(Tier.TIER_5)).component(ComponentsRegistry.CELL_DATA, new CellData.Component(FluidStack.EMPTY))));
    ...
    public static final DeferredHolder<Item, Item> COPPER_MAGMATOR_BLOCK_ITEM = ITEMS.register(COPPER_MAGMATOR_TAG, () -> new BlockItem(COPPER_MAGMATOR_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(COPPER_MAGMATOR_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> IRON_MAGMATOR_BLOCK_ITEM = ITEMS.register(IRON_MAGMATOR_TAG, () -> new BlockItem(IRON_MAGMATOR_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(IRON_MAGMATOR_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> GOLD_MAGMATOR_BLOCK_ITEM = ITEMS.register(GOLD_MAGMATOR_TAG, () -> new BlockItem(GOLD_MAGMATOR_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(GOLD_MAGMATOR_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> DIAMOND_MAGMATOR_BLOCK_ITEM = ITEMS.register(DIAMOND_MAGMATOR_TAG, () -> new BlockItem(DIAMOND_MAGMATOR_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(DIAMOND_MAGMATOR_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> NETHERITE_MAGMATOR_BLOCK_ITEM = ITEMS.register(NETHERITE_MAGMATOR_TAG, () -> new BlockItem(NETHERITE_MAGMATOR_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(NETHERITE_MAGMATOR_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> STYGIAN_ANVIL_BLOCK_ITEM = ITEMS.register(STYGIAN_ANVIL_TAG, () -> new BlockItem(STYGIAN_ANVIL_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(STYGIAN_ANVIL_TAG)))));
    ...
    public static final DeferredHolder<Item, Item> STYGIAN_BLOCK_ITEM = ITEMS.register(STYGIAN_BLOCK_TAG, () -> new BlockItem(STYGIAN_BLOCK.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Woot.identifier(STYGIAN_BLOCK_TAG)))));
}
